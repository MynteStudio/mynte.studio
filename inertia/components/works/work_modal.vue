        ...
        <div class="relative w-full h-screen max-w-[2560px] mx-auto overflow-hidden">
          ...
          >
            ...
            >
              ...
              >
                <span class="keypoint" v-for="(point, index) in work.keypoints" :key="index">{{
                  point
                }}</span>
              </div>
            </div>
            ...
            <div class="w-full lg:w-auto lg:max-w-2/5 order-3 lg:order-1 lg:mt-10">
              <h5 class="mb-8 lg:mb-20">OUR ROLE IN THIS PROJECT</h5>
              <p class="text-justify line-height-[20px]" v-html="work.workDescription"></p>
            </div>
