...
export const Hero = () => {
  ...
  return (
    <section className="min-h-[calc(100vh_-_175px)] mx-5 flex flex-col items-center justify-between text-center">
      <div></div>
      <div className="flex flex-col items-center">
        <h1 className="pt-6 text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-semibold text-center max-w-[20ch] line-height-[120%]">
          <span
            className={
              (i18n.language === 'en'
