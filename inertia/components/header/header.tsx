...
export const Header = () => {
  ...
  return (
    <header
      dir="ltr"
      className="container fixed top-0 left-0 right-0 mx-auto z-99 px-5 py-5 lg:py-9 grid grid-cols-2 md:grid-cols-4 items-center text-sm"
    >
      {/* NOTE: left */}
      ...
      {/* NOTE: center */}
      <div className="hidden lg:flex col-start-2 col-end-4">
        <DynamicIsland />
      </div>
